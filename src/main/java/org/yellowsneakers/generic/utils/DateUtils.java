...
import org.yellowsneakers.core.tools.Week;
...
import org.yellowsneakers.generic.utils.date.TimeInterval;
...
public class DateUtils {
	...
	/**
	 * 转换为{@link DateTimes}对象
	 * 
	 * @return 当前时间
	 */
	public static DateTimes date() {
		return new DateTimes();
	}

	/**
	 * {@link Date}类型时间转为{@link DateTimes}
	 * 
	 * @param date Long类型Date（Unix时间戳）
	 * @return 时间对象
	 * @since 3.0.7
	 */
	public static DateTimes date(Date date) {
	...
	/**
	 * Long类型时间转为{@link DateTimes}<br>
	 * 同时支持10位秒级别时间戳和13位毫秒级别时间戳
	 * 
	 * @param date Long类型Date（Unix时间戳）
	 * @return 时间对象
	 */
	public static DateTimes date(long date) {
		return new DateTimes(date);
	}

	/**
	 * {@link Calendar}类型时间转为{@link DateTimes}
	 * 
	 * @param calendar {@link Calendar}
	 * @return 时间对象
	 */
	public static DateTimes date(Calendar calendar) {
	...
	public static String now() {
		return formatDateTime(new DateTimes());
	}
	...
	public static String today() {
		return formatDate(new DateTimes());
	}
	...
	public static int season(Date date) {
		return DateTimes.of(date).season();
	}
	...
	public static int month(Date date) {
		return DateTimes.of(date).month();
	}
	...
	public static Month monthEnum(Date date) {
		return DateTimes.of(date).monthEnum();
	}
	...
	public static int weekOfYear(Date date) {
		return DateTimes.of(date).weekOfYear();
	}
	...
	public static int weekOfMonth(Date date) {
		return DateTimes.of(date).weekOfMonth();
	}
	...
	public static int dayOfMonth(Date date) {
		return DateTimes.of(date).dayOfMonth();
	}
	...
	public static int dayOfWeek(Date date) {
		return DateTimes.of(date).dayOfWeek();
	}
	...
	public static Week dayOfWeekEnum(Date date) {
		return DateTimes.of(date).dayOfWeekEnum();
	}
	...
	public static int hour(Date date, boolean is24HourClock) {
		return DateTimes.of(date).hour(is24HourClock);
	}
	...
	public static int minute(Date date) {
		return DateTimes.of(date).minute();
	}
	...
	public static int second(Date date) {
		return DateTimes.of(date).second();
	}
	...
	public static int millsecond(Date date) {
		return DateTimes.of(date).millsecond();
	}
	 ...
	 * @return DateTime对象
	 */
	public static DateTimes parse(String dateStr, DateFormat dateFormat) {
		return new DateTimes(dateStr, dateFormat);
	}
	 ...
	 * @return DateTime对象
	 */
	public static DateTimes parse(String dateStr, DateParser parser) {
		return new DateTimes(dateStr, parser);
	}
	 ...
	 * @return 日期对象
	 */
	public static DateTimes parse(String dateStr, String format) {
	 ...
	 * @return 日期对象
	 */
	public static DateTimes parseDateTime(String dateString) {
	 ...
	 * @return 日期对象
	 */
	public static DateTimes parseDate(String dateString) {
		dateString = normalize(dateString);
	 ...
	 * @return 日期对象
	 */
	public static DateTimes parseTime(String timeString) {
	 ...
	 * @since 3.1.1
	 */
	public static DateTimes parseTimeToday(String timeString) {
		timeString = StringUtils.format("{} {}", today(), timeString);
		return parse(timeString, DatePattern.NORM_TIME_FORMAT);
	}

	/**
	 * 将日期字符串转换为{@link DateTimes}对象，格式：<br>
	 * <ol>
	 ...
	 * @return 日期
	 */
	public static DateTimes parse(String dateStr) {
		if (null == dateStr) {
			return null;
		}
	 ...
	 */
	public static DateTimes beginOfDay(Date date) {
		return new DateTimes(beginOfDay(calendar(date)));
	}
	 ...
	 * @return {@link DateTimes}
	 */
	public static DateTimes endOfDay(Date date) {
		return new DateTimes(endOfDay(calendar(date)));
	}
	 ...
	 * @return {@link DateTimes}
	 */
	public static DateTimes beginOfWeek(Date date) {
		return new DateTimes(beginOfWeek(calendar(date)));
	}
	 ...
	 * @return {@link DateTimes}
	 */
	public static DateTimes endOfWeek(Date date) {
		return new DateTimes(endOfWeek(calendar(date)));
	}
	 ...
	 * @return {@link DateTimes}
	 */
	public static DateTimes beginOfMonth(Date date) {
		return new DateTimes(beginOfMonth(calendar(date)));
	}
	 ...
	 * @return {@link DateTimes}
	 */
	public static DateTimes endOfMonth(Date date) {
		return new DateTimes(endOfMonth(calendar(date)));
	}
	 ...
	 * @return {@link DateTimes}
	 */
	public static DateTimes beginOfYear(Date date) {
		return new DateTimes(beginOfYear(calendar(date)));
	}
	 ...
	 * @return {@link DateTimes}
	 */
	public static DateTimes endOfYear(Date date) {
		return new DateTimes(endOfYear(calendar(date)));
	}
	...
	public static DateTimes yesterday() {
		return offsetDay(new DateTimes(), -1);
	}
	 ...
	 * @since 3.0.1
	 */
	public static DateTimes tomorrow() {
		return offsetDay(new DateTimes(), 1);
	}
	 ...
	 * @return 上周
	 */
	public static DateTimes lastWeek() {
		return offsetWeek(new DateTimes(), -1);
	}
	 ...
	 * @since 3.0.1
	 */
	public static DateTimes nextWeek() {
		return offsetWeek(new DateTimes(), 1);
	}
	 ...
	 * @return 上个月
	 */
	public static DateTimes lastMonth() {
		return offsetMonth(new DateTimes(), -1);
	}
	 ...
	 * @since 3.0.1
	 */
	public static DateTimes nextMonth() {
		return offsetMonth(new DateTimes(), 1);
	}
	 ...
	 * @return 偏移后的日期
	 */
	public static DateTimes offsetMillisecond(Date date, int offset) {
	 ...
	 * @return 偏移后的日期
	 */
	public static DateTimes offsetSecond(Date date, int offset) {
	 ...
	 * @return 偏移后的日期
	 */
	public static DateTimes offsetMinute(Date date, int offset) {
	 ...
	 * @return 偏移后的日期
	 */
	public static DateTimes offsetHour(Date date, int offset) {
	 ...
	 * @return 偏移后的日期
	 */
	public static DateTimes offsetDay(Date date, int offset) {
	 ...
	 * @return 偏移后的日期
	 */
	public static DateTimes offsetWeek(Date date, int offset) {
	 ...
	 * @return 偏移后的日期
	 */
	public static DateTimes offsetMonth(Date date, int offset) {
	 ...
	 * @return 偏移后的日期
	 */
	public static DateTimes offset(Date date, DateField dateField, int offset) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.add(dateField.getValue(), offset);
		return new DateTimes(cal.getTime());
	}
	 ...
	 * @param offset 偏移量，正数为向后偏移，负数为向前偏移
	 * @return 偏移后的日期
	 * @deprecated please use {@link DateUtils#offset(Date, DateField, int)}
	 */
	@Deprecated
	public static DateTimes offsetDate(Date date, DateField dateField, int offset) {
	...
	public static boolean isIn(Date date, Date beginDate, Date endDate) {
		if (date instanceof DateTimes) {
			return ((DateTimes) date).isIn(beginDate, endDate);
		} else {
			return new DateTimes(date).isIn(beginDate, endDate);
		}
	}
	...
	public static int timeToSecond(String timeStr) {
		...
		final List<String> hms = StringUtils.splitTrim(timeStr, StringUtils.C_COLON, 3);
